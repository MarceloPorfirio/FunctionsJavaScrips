...
let colecao_signos = [  // Cria a coleção de dados
...
const retorna_signo =   (signos,data) =>{ // cria a função 
    //return signos[4]['Nome'] // pega o primeiro nome do signo
...
const nome_signo = retorna_signo(colecao_signos,data_app) // atribui a a função para nome signo
